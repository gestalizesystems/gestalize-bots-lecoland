...
function montarContexto(cliente) {
  ...
  return [
    ...
    "- NÃO TRABALHAMOS COM: (1) Vermífugo/remédio para verme INJETÁVEL — não temos essa apresentação; temos apenas comprimido/pasta oral. (2) Anticoncepcional para animais — não trabalhamos com esse tipo de medicamento. Informe ao cliente com gentileza e, se quiser, sugira procurar um veterinário ou outra petshop especializada.",
